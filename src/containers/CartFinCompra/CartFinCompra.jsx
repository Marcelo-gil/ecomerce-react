        ...
        const nuevoId = await runTransaction(db, async (transaction) => {
            for (const item of carrito) {
                ...
                if (productoDoc.data().stock >= cantidad) {                    
                    transaction.update(productoRef, { stock: productoDoc.data().stock-cantidad });
                } else {
        ...
        guardarCompra()
            .then(result => {
                swal({
                    ...
                    text: "Estimado " + datosComprador.nombre + " tu numero de Verificación es " + result.id ,
                    icon: "success",
                    button: "Tomé Nota!",                                       
        ...
        totalCarrito !== 0 ?
            <>
                ...
                <Box w='50%' bg="#E6FFFA" borderWidth='1px' borderRadius='lg' overflow='hidden'>
                    ...
                    <Stack>
                        <FormControl isRequired isInvalid={datosComprador.nombre.trim() === ""}>
                    ...
                    <Center>
                        ...
                        <Button ml="5" mt="5" colorScheme="blackAlpha" type="Submit" className="button" onClick={finalizarCompra}>Finalizar Compra</Button>
                    </Center>
                </Box>
                </Center>
            </>
